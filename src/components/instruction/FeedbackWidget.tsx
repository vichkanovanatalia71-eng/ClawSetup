      ...
      {submitted ? (
        ...
        <div className="flex justify-center gap-3">
          <motion.button
            whileTap={{ scale: 0.95 }}
            onClick={() => submit(true)}
            className="w-10 h-10 rounded-xl shadow-neu-xs flex items-center justify-center text-green-500 hover:shadow-neu-inset-sm transition-all"
          >
          ...
          <motion.button
            ...
            className="w-10 h-10 rounded-xl shadow-neu-xs flex items-center justify-center text-red-400 hover:shadow-neu-inset-sm transition-all"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
